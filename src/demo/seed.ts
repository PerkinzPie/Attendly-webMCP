...
export const demoOrganisations: readonly DemoOrganisation[] = [
  {
    ...
    initials: 'WP',
    description: 'School events, family activities and community gatherings for Willowbrook families.',
    isSynthetic: true,
  },
  {
    id: 'org_westbrook_pta',
    name: 'Friends of Willowbrook Primary',
    type: 'PTA',
    location: 'Cheltenham, Gloucestershire',
    initials: 'FW',
    description: 'Fundraisers and social events supporting pupils and families at Willowbrook.',
    isSynthetic: true,
  },
  {
    id: 'org_st_lukes',
  ...
  },
  {
    ...
    name: 'Kingsmead Community Sports Club',
    type: 'Sports club',
...
export const demoEvents: readonly DemoEvent[] = [
  event({
    id: 'evt_autumn_fair', organisationId: 'org_westbrook_school', name: 'Willowbrook Autumn Fair',
  ...
  event({
    id: 'evt_winter_market', organisationId: 'org_westbrook_pta', name: 'Willowbrook Winter Market',
